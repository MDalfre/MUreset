                    ...
                    itemsIndexed(state.characters) { index, character ->
                        ...
                        Card(
                            ...
                            Column(modifier = Modifier.padding(12.dp)) {
                                ...
                                Text(
                                    text = "Points/Reset ${character.pointsPerReset} | Overflow ${
                                        formatAttribute(
                                            character.overflowAttribute,
                                        )
                                    }",
                                    fontSize = 12.sp,
                                ...
                                Text(
                                    text =
                                        "Str ${character.str} | Agi ${character.agi} | Sta ${character.sta} " +
                                            "| Ene ${character.ene} | Cmd ${character.cmd}",
                                    fontSize = 12.sp,
                                    color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.75f),
                                )
